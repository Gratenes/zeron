...
#[cfg(not(target_arch = "wasm32"))]
use kratos_rpc::{RpcReply, RpcService, connect_ws, memory_client};
...
pub struct AppState {
    ...
    pub update: Option<kratos_proto::UpdateStatus>,
...
impl AppState {
    ...
    pub fn apply_update(&mut self, status: kratos_proto::UpdateStatus) {
