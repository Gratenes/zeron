...
pub mod methods {
    // Browser-hosted authentication is normally handled by the edge BFF. Keep
    // these protocol names for the shared shell's legacy account gate.
    pub const SIGN_IN: &str = "SignIn";
    pub const LIST_ORGS: &str = "ListOrganizations";
    pub const CREATE_ORG: &str = "CreateOrganization";
    pub const SELECT_ORG: &str = "SelectOrganization";
